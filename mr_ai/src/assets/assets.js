...
import { SquarePen, Hash, Image, Eraser, Scissors, FileText, BarChart3 } from 'lucide-react'
...
export const AiToolsData = [
    ...
    },
    {
        ...
        description: 'Optimize your website content for search engines with our AI-powered SEO tools.',
        Icon: BarChart3,
        bg: { from: '#20C363', to: '#11B97E' },
        path: '/ai/Seo-optimize'
    },
